...
public class IncreaseSelf : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        otherActions.activationForPlayerIncreaseSelf = ballMovement.lastPlayerTouched;           // Averigua quien es el jugador que ha golpeado el PowerUp
        otherActions.StartIncreaseSelf();                                                        // Como al destruirse no terminará de ejecutar la Corrutina, se ejecuta en su lugar una función 
